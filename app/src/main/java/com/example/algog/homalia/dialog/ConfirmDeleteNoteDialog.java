...
public class ConfirmDeleteNoteDialog extends DialogFragment implements DialogInterface.OnClickListener {
    // Constantes
    ...
    // Variables
    private ConfirmDeleteNoteDialog.OnRealizarAccion escuchador;
    private int position;

    // Constructor artificial
    public static ConfirmDeleteNoteDialog newInstance(int position){
        Bundle args = new Bundle();
        args.putInt(KEY_POSITION, position);
        ConfirmDeleteNoteDialog dialogo = new ConfirmDeleteNoteDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(getString(R.string.confirm_delete_note_dialog_title))
    ...
    public void setOnRealizarAccionListener(ConfirmDeleteNoteDialog.OnRealizarAccion escuchador){
